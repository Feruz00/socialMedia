...
import Postbyuser from './components/PostById/PostByUser';
function App() {
  return (
    <>
    <Router>
          ...
          <Switch>
            ...
            <SocketProvider>
              <ConversationProvider>
                ...
                <FadingRoute exact path="/newpost"  component={Createpost} access={true}/>
                <FadingRoute exact path="/post/:feruz"  component={Postbyuser} access={true}/>
                <FadingRoute exact path="/posts/:postId"  component={Postbyid} access={true}/>
                <FadingRoute exact path="/direct"  component={Direct} access={true}/>
                <FadingRoute exact path="/settings"  component={Profile} access={true}/>
                <FadingRoute exact path="/notifications"  component={Notifications} access={true}/>
